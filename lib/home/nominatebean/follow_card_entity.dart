class FollowCardEntity {
	...
	FollowCardEntity({this.data, this.adIndex, this.tag, this.id, this.type});

	FollowCardEntity.fromJson(Map<String, dynamic> json) {
		data = json['data'] != null ? new FollowCardData.fromJson(json['data']) : null;
...
class FollowCardData {
	String dataType;
	FollowCardDataHeader header;
	FollowCardDataContent content;
	List<Null> adTrack;

	FollowCardData({this.dataType, this.header, this.content, this.adTrack});

	FollowCardData.fromJson(Map<String, dynamic> json) {
